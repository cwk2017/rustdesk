...
#
# - versionName from https://github.com/cwk2017/rustdesk/releases/download/fdroid-version/rustdesk-version.txt
# - versionCode from https://github.com/cwk2017/rustdesk/releases/download/fdroid-version/rustdesk-version.txt
